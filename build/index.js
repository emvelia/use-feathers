(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.useFeathers = {}, global.React));
    ...
    */
    ...
    var FeathersContext = React__default["default"].createContext(null);
    var useFeathers = function () { return React.useContext(FeathersContext); };
    var initialState = {};
    var FeathersProvider = function (_a) {
        ...
        var _d = React.useState(null), userInfo = _d[0], setUserInfo = _d[1];
        var _e = React.useReducer(reducer(idFieldName), initialState), state = _e[0], dispatch = _e[1];
        ...
        return (React__default["default"].createElement(FeathersContext.Provider, { value: value }, children));
    };
    ...
    exports.FeathersProvider = FeathersProvider;
    exports.useFeathers = useFeathers;
